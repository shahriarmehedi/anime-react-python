        ...
        <>
            <div className="carousel w-full">
                <div id="slide1" className="carousel-item relative w-full max-h-screen">
                    <img src="https://www.teahub.io/photos/full/113-1137876_anime-guns-weapons-manga-anime-girls-white-background.jpg" className="w-full object-cover" />
                ...
                <div id="slide2" className="carousel-item relative w-full max-h-screen">
                    <img src="https://www.teahub.io/photos/full/67-670663_hollywood-movie-poster-hd.jpg" className="w-full object-cover" />
                    <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
